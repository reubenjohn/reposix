...
## [0.14.0](https://github.com/reubenjohn/reposix/compare/reposix-confluence-v0.13.0...reposix-confluence-v0.14.0) - 2026-07-08
...
## [0.13.0](https://github.com/reubenjohn/reposix/compare/reposix-confluence-v0.12.0...reposix-confluence-v0.13.0) - 2026-07-07
...
- *(confluence)* self-seeding hierarchy test + document protected durable fixtures (D91-08)
- *(confluence)* add capabilities self-check matching github/jira pattern (connector re-audit)
