...
## [0.14.1](https://github.com/reubenjohn/reposix/compare/reposix-sim-v0.14.0...reposix-sim-v0.14.1) - 2026-07-19
...
## [0.13.1](https://github.com/reubenjohn/reposix/compare/reposix-sim-v0.13.0...reposix-sim-v0.13.1) - 2026-07-08

### Added

- *(sim)* honest one-line startup banner on stderr
...
## [0.11.2](https://github.com/reubenjohn/reposix/compare/reposix-sim-v0.11.1...reposix-sim-v0.11.2) - 2026-04-27

### Other

- §0.3 + §0.4 — rename version-pinned files, hoist token-economy bench into nav

## [0.11.1](https://github.com/reubenjohn/reposix/compare/reposix-sim-v0.11.0...reposix-sim-v0.11.1) - 2026-04-27

### Added

- *(doctor)* print backend capability matrix row (POLISH2-08, persona-coding-agent fix #3)
- *(33-01)* sim list_issues honors ?since=<RFC3339> query param
...
- *(04-01)* extend demo seed to 6 issues for SG-02 bulk-delete demo
- *(02-02)* rate-limit layer + run_with_listener + integration tests
- *(02-02)* audit middleware + body capture + DB write
- *(02-01)* issue CRUD routes + transitions wired through AppState
- *(02-01)* sim storage layer — AppState, db.rs, seed.json, ApiError
- scaffold workspace, CI, CLAUDE.md, PROJECT.md with security guardrails

### Fixed

- *(cargo)* version field on workspace.dependencies reposix-core + archive tag-v0.4.0.sh
- *(clippy)* replace map+unwrap_or(false) with is_ok_and across all test files
- *(clippy)* replace map+unwrap_or(false) with is_ok_and in ETag check

### Other

- *(sim)* cargo fmt for POLISH2-14 SimError test block
- *(sim)* typed SimError, drop anyhow from library API (POLISH2-14, code-quality P1-4)
...
- rustfmt after is_ok_and ETag fix
...
- *(drive-by)* rename stale TODO(phase-3)/v0.2 comments (OP-6 MEDIUM-10/11)
