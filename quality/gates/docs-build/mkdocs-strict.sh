#!/usr/bin/env bash
#
# quality/gates/docs-build/mkdocs-strict.sh — POLISH-17 / OP-4 self-improving infrastructure.
#
# Migrated from scripts/check-docs-site.sh per P60 SIMPLIFY-08 (2026-04-27).
# Path-arithmetic depth changed from 1 to 3 (was scripts/, now quality/gates/docs-build/).
#
...
echo "quality/gates/docs-build/mkdocs-strict.sh: running mkdocs build --strict..." >&2
