#!/usr/bin/env bash
#
# quality/gates/docs-build/mermaid-renders.sh — enforce that every mermaid-bearing docs page
#
# Migrated from scripts/check-mermaid-renders.sh per P60 SIMPLIFY-08 (2026-04-27).
