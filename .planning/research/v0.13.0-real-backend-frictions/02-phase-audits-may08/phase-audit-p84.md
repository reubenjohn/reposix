...
- Corroborating dark-factory observation: `.planning/research/v0.13.0-real-backend-frictions/T2-attach.md:41-44` notes the live `reubenjohn/reposix-tokenworld-mirror` clone contains only `README.md` + the workflow YAML — meaning the live mirror has NEVER had a successful end-to-end sync at the time of audit (consistent with the SURPRISES-INTAKE substrate gap, but also consistent with the self-clobber hypothesis above).
...
**Evidence:** `.planning/research/v0.13.0-real-backend-frictions/T3-bus-push.md:160-175`, SUMMARY.md cluster G/H.
