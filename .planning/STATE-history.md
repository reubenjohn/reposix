...
workstreams that have shipped or been resequenced, plus stale reference and resolved
blockers. The live cursor — frontmatter, current position, current focus, the
...
### Phase decomposition + pre-kickoff scaffolding (superseded)
