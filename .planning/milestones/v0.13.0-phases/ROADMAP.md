...
**Requirements:** RBF-A-01, RBF-A-02, RBF-A-03, RBF-A-04, RBF-A-05, RBF-A-06, RBF-A-07 · **Depends on:** P89 GREEN, P90 GREEN · **Plan:** TBD (P91 plan-overview not yet authored)
...
6. **Mid-stream litmus checkpoint (Decision 1):** After this phase declares GREEN, re-run dark-factory T2 against TokenWorld. If ≥1 HIGH-severity friction surfaces, this phase REOPENS — P92 MUST NOT start until T2 returns ≤0 HIGH frictions. The checkpoint is a phase gate, not a soft success criterion.
