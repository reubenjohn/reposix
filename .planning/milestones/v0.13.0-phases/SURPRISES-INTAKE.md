...
**STATUS:** OPEN — sole remaining red on `agent-ux/real-git-push-e2e`. Home: next reposix-remote/reposix-cache push-path phase (git>=2.34 required). The fetch path is DONE; do not re-litigate it. BLOCKS the P0 row PASS and the QL-001 waiver deadline (2026-07-31).
