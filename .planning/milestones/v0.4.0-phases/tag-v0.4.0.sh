...
#
# Usage:  bash scripts/tag-v0.4.0.sh
#
...
echo "[guard 5/7] CHANGELOG.md has [v0.4.0] section"
...
# 8. Extract v0.4.0 body from CHANGELOG for the tag message.
...
echo "and paste the CHANGELOG v0.4.0 section as the body."
