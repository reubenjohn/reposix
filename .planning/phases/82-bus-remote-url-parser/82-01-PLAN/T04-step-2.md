...
## Task 82-01-T04 (continued) — `bus_handler.rs` module body, HARD-BLOCKs, commit

Continued from [T04 step 1](./T04-step-1.md) (State extension + URL dispatch + capabilities + export branching).
