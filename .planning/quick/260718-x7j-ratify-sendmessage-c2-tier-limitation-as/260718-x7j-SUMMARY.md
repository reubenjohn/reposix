...
tags: [orchestration, sendmessage, c2-tier, tool-grant, consult-decisions, manager-decide-and-disclose]
...
provides:
  ...
  - "2026-07-18 [MANAGER decide-and-disclose, owner veto open] ratifying ledger entry in CONSULT-DECISIONS.md with finding, re-discovery provenance, ruling, and standing mitigation"
...
key-decisions:
  - "Ratified SendMessage's absence at the phase-coordinator (C2) tier as STANDING doctrine (2026-07-18) rather than a session/config fluke to keep re-diagnosing — the finding had independently resurfaced across the #63→#64→#65 handover chain (2nd/3rd re-discovery this milestone). Ruled under the manager's delegated decide-and-disclose authority; the owner's veto window on this ruling is still open (corrected 2026-07-19 — see forward-fix commit; not an [OWNER] decision)."
...
**MANAGER decide-and-disclose ruling (owner veto open), 2026-07-18, encoding the SendMessage phase-coordinator (C2) tool-grant limitation into ORCHESTRATION.md §3/§11 plus a matching CONSULT-DECISIONS.md ledger entry, landed in one fix-it-twice commit.**
...
- `.planning/CONSULT-DECISIONS.md` - Appended the terminal `## 2026-07-18 [MANAGER decide-and-disclose, owner veto open]` ledger entry ratifying the finding as STANDING doctrine with re-discovery provenance and the ORCHESTRATION §3/§11 cross-reference.
