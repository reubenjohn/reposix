---
last_measured_at: 2026-06-08T14:29:40Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-06-08T14:29:40Z (commit `91a2f33`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 30 ms             | 28 ms              | 27 ms              | 727 ms              |
| List records [^N]                             | 9 ms (N=6)             | 500 ms (N=43)              | 243 ms (N=1)              | 475 ms (N=0)              |
| Get one record                                | 8 ms              | 240 ms               | 258 ms               | n/a               |
| PATCH record (no-op)                          | 12 ms            | 802 ms             | 253 ms             | n/a             |
