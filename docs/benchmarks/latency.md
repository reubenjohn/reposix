---
last_measured_at: 2026-07-20T15:14:42Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-07-20T15:14:42Z (commit `91164d5`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 43 ms             | 900 ms              | 879 ms              | 421 ms              |
| List records [^N]                             | 8 ms (N=6)             | 549 ms (N=70)              | 196 ms (N=3)              | 357 ms (N=0)              |
| Get one record                                | 8 ms              | 233 ms               | 296 ms               | n/a               |
| PATCH record (no-op)                          | 11 ms            | 597 ms             | 330 ms             | n/a             |
| Helper `capabilities` probe                 | 5 ms              | 5 ms               | 7 ms               | 7 ms               |
