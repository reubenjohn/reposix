---
last_measured_at: 2026-09-21T18:33:42Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-09-21T18:33:42Z (commit `91164d5`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 54 ms             | 773 ms              | 1038 ms              | 434 ms              |
| List records [^N]                             | 8 ms (N=6)             | 668 ms (N=77)              | 300 ms (N=3)              | 373 ms (N=0)              |
| Get one record                                | 8 ms              | 273 ms               | 266 ms               | n/a               |
| PATCH record (no-op)                          | 11 ms            | 670 ms             | 310 ms             | n/a             |
| Helper `capabilities` probe                 | 6 ms              | 6 ms               | 8 ms               | 8 ms               |
