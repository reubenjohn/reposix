---
last_measured_at: 2026-06-22T14:58:46Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-06-22T14:58:46Z (commit `91a2f33`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 62 ms             | 28 ms              | 28 ms              | 27 ms              |
| List records [^N]                             | 10 ms (N=6)             | 717 ms (N=47)              | 407 ms (N=1)              | 196 ms (N=0)              |
| Get one record                                | 9 ms              | 281 ms               | 357 ms               | n/a               |
| PATCH record (no-op)                          | 13 ms            | 735 ms             | 373 ms             | n/a             |
| Helper `capabilities` probe                 | 6 ms              | 6 ms               | 6 ms               | 6 ms               |
