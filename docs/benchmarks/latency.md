---
last_measured_at: 2026-05-18T14:16:13Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-05-18T14:16:13Z (commit `91a2f33`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 32 ms             | 31 ms              | 29 ms              | 29 ms              |
| List records [^N]                             | 10 ms (N=6)             | 607 ms (N=37)              | 258 ms (N=1)              | 387 ms (N=0)              |
| Get one record                                | 9 ms              | 290 ms               | 283 ms               | n/a               |
| PATCH record (no-op)                          | 13 ms            | 899 ms             | 326 ms             | n/a             |
| Helper `capabilities` probe                 | 9 ms              | 6 ms               | 6 ms               | 6 ms               |
