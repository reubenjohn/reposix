---
last_measured_at: 2026-07-13T15:44:38Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-07-13T15:44:38Z (commit `e73d761`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 56 ms             | 1192 ms              | 531 ms              | 303 ms              |
| List records [^N]                             | 9 ms (N=6)             | 1115 ms (N=64)              | 261 ms (N=2)              | 232 ms (N=0)              |
| Get one record                                | 9 ms              | 364 ms               | 140 ms               | n/a               |
| PATCH record (no-op)                          | 13 ms            | 691 ms             | 195 ms             | n/a             |
| Helper `capabilities` probe                 | 6 ms              | 6 ms               | 7 ms               | 7 ms               |
