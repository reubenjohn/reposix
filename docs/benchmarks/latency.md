---
last_measured_at: 2026-05-11T13:58:19Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-05-11T13:58:19Z (commit `91a2f33`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 28 ms             | 26 ms              | 27 ms              | 26 ms              |
| List records [^N]                             | 9 ms (N=6)             | 626 ms (N=35)              | 285 ms (N=1)              | 385 ms (N=0)              |
| Get one record                                | 9 ms              | 300 ms               | 348 ms               | n/a               |
| PATCH record (no-op)                          | 12 ms            | 762 ms             | 356 ms             | n/a             |
| Helper `capabilities` probe                 | 5 ms              | 5 ms               | 6 ms               | 6 ms               |
