---
last_measured_at: 2026-08-31T19:28:22Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-08-31T19:28:22Z (commit `91164d5`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 152 ms             | 724 ms              | 1128 ms              | 670 ms              |
| List records [^N]                             | 10 ms (N=6)             | 565 ms (N=75)              | 306 ms (N=3)              | 245 ms (N=0)              |
| Get one record                                | 9 ms              | 266 ms               | 178 ms               | n/a               |
| PATCH record (no-op)                          | 12 ms            | 602 ms             | 274 ms             | n/a             |
| Helper `capabilities` probe                 | 6 ms              | 7 ms               | 9 ms               | 9 ms               |
