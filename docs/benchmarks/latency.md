---
last_measured_at: 2026-06-01T15:12:33Z
---

# v0.9.0 Latency Envelope

**Generated:** 2026-06-01T15:12:33Z (commit `91a2f33`)
...
|-----------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| `reposix init` cold [^blob]                 | 41 ms             | 27 ms              | 29 ms              | 28 ms              |
| List records [^N]                             | 9 ms (N=6)             | 952 ms (N=41)              | 387 ms (N=1)              | 530 ms (N=0)              |
| Get one record                                | 9 ms              | 429 ms               | 341 ms               | n/a               |
| PATCH record (no-op)                          | 12 ms            | 1209 ms             | 390 ms             | n/a             |
