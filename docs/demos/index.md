...
| 4 | [`04-token-economy.sh`](https://github.com/reubenjohn/reposix/blob/main/scripts/demos/04-token-economy.sh)           | buyer       |    ~10s | 89.1% fewer tokens vs a synthesized MCP-tool-catalog baseline for the same task.                    | [typescript](recordings/04-token-economy.typescript) · [transcript](recordings/04-token-economy.transcript.txt)                                                                   |
